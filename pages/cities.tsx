...
import { LIST_CITIES, REMOVE_CITY, REPORT_CITIES } from '../src/graphql/city';
  ...
  return (
    <CustomMenu>
      <CustomList 
        new={'city'} 
        columns={columns}
        method_list={LIST_CITIES}
        method_remove={REMOVE_CITY}
        method_report={REPORT_CITIES}
        columnsReport={columnsReport}
        titleReport={'Relatório de cidades'}
      />
    </CustomMenu>
  )
}
